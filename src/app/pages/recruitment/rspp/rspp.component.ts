...
@Component({
  ...
  styleUrls: ['./rspp.component.scss'],
})
export class RsppComponent {
  user: any;
  breadCrumbItems: any = [];
  submitted = false;
  ...
  constructor(
    ...
    this.referralCode = this.referralCode?.replace(/\D/g, "");
          ...
          setTimeout(() => {
            ...
            if (
              ...
              this.commonService.sendNotification(
                this.requirement.createdBy,
                'The RSPP has been updated by the client.',
    ...
    this.commonService
      ...
      .subscribe((data: any) => {
        ...
        if (data['result'] === 200) {
          ...
          if (this.otherJobFamily) this.saveOtherJobFamily(this.requirement.id);
        } else {
  ...
  checkNewJobFamilyName(l1l2: any): void {
    let url =
      'mainservice/framework2/forward?api=recruitmentservice/requirement/checkJobFamilyByName?name=' +
  ...
  saveOtherJobFamily(reqId: any): void {
    ...
    let body = {
      jobFamilyL1: this.otherJobFamilyL1
        ? this.otherJobFamilyL1
        : this.selectedJobFamilyL1.name,
      jobFamilyL2: this.otherJobFamilyL2,
      reqId: reqId,
    };
    this.commonService.post(url, body).subscribe((data: any) => {});
  }
