...
@Component({
  selector: 'app-piecos-analysis',
  templateUrl: './piecos-analysis.component.html',
  styleUrls: ['./piecos-analysis.component.scss']
})
export class PiecosAnalysisComponent {
constructor(public commonService: PieworksCommonService) {
    ...
    loadReport(): void {
        ...
        this.data = [];
        var url = "mainservice/framework2/piecosAnalysis?startDate="+this.startDate+"&endDate="+this.endDate+"&communityId=" + localStorage.getItem("communityId");
